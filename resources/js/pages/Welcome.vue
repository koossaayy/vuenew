        ...
        >
            ...
            >
                ...
                >
                    ...
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]"> {{ $t('Laravel has an incredibly rich ecosystem.') }} <br />{{ $t('We suggest starting with the following.') }} </p>
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        ...
                        >
                            ...
                            <span> {{ $t('Watch video tutorials at') }} <a
